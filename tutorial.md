...
```bash
    ...
    snakemake --use-conda -s ../benchmark_snakemake/snakefile --cores 10
```
**Note:** For more detailed usage of the workflow check the [snakemake.md](benchmark_snakemake/snakemake.md) file